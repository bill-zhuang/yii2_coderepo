 ...
 * @since 2.0
 */
class YiiModelGenerator extends \yii\gii\Generator
{
    public $db = 'db';
    ...
    public function getDbConnection()
    {
        ...
        if ($this->db_connection == null)
        {
            ...
            $this->db_connection->dsn = $db_config['dsn'];
            $this->db_connection->username = $db_config['username'];
            $this->db_connection->password = $db_config['password'];
            $this->db_connection->charset = $db_config['charset'];
        }
